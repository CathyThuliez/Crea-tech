...
const MentionLegale = () => {
  return (
    <section className="mentions-Legales" id="Mentions-Legales">
      <Header />
      ...
      <div className="mention_content">
        ...
        <p>
          ...
          Prestations et Services: <a href="https://crea-tech.fr">Crea-tech</a>{" "}
        ...
        <p>
          ...
          d'être détenues par
          <a href="https://crea-tech.fr">Crea-tech</a> pour la gestion de votre
        ...
        <p>
          ...
          du site internet
          <a href="https://crea-tech.fr">Crea-tech.fr</a> l'identité des
          différents intervenants dans le cadre de sa réalisation et de son
          suivi :
        </p>
        <p>
          <strong>Propriétaire</strong> : Créa-tech, Numéro de siret :
          94899371200017 – 201 résidence Léo Ferré, rue Jacques Prévert, 62110
          Hénin-Beaumont.
          <br />
          <strong>Responsable publication</strong> : Cathy Thuliez –
          contact@crea-tech.fr
          <br />
          Le responsable publication est une personne physique ou une personne
          morale.
          <br />
          <strong>Webmaster</strong> : Cathy Thuliez – contact@crea-tech.fr
          <br />
          <strong>Hébergeur</strong> : ovh – 2 rue Kellermann 59100 Roubaix 1007
          <br />
          <strong>Déléguée à la protection des données</strong> : Cathy Thuliez
          – contact@crea-tech.fr
          <br />
        </p>
        ...
        <p>
          L’utilisation du site <a href="https://crea-tech.fr">Crea-tech</a>{" "}
          ...
          utilisateurs du site <a href="https://crea-tech.fr">Crea-tech</a> sont
        ...
        <p>
          ...
          <a href="https://crea-tech.fr">Crea-tech</a>, qui s’efforcera alors de
          communiquer préalablement aux utilisateurs les dates et heures de
          l’intervention. Le site web{" "}
          <a href="https://crea-tech.fr">Crea-tech</a> est mis à jour
          régulièrement par <a href="https://crea-tech.fr">Crea-tech</a>. De la
        ...
        <p>
          Le site internet <a href="https://crea-tech.fr">Crea-tech</a> a pour
          objet de fournir une information concernant l’ensemble des activités
          de la société.
          <a href="https://crea-tech.fr">Crea-tech</a> s’efforce de fournir sur
          le site <a href="https://crea-tech.fr">Crea-tech</a>
        ...
        <p>
          ...
          <a href="https://crea-tech.fr">Crea-tech</a>sont données à titre
          indicatif, et sont susceptibles d’évoluer. Par ailleurs, les
          renseignements figurant sur le site
          <a href="https://crea-tech.fr">Crea-tech</a>
        ...
        <p>
          ...
          <a href="https://crea-tech.fr">Crea-tech</a> est hébergé chez un
        ...
        <p>
          <a href="https://crea-tech.fr">Crea-tech</a> et l’hébergeur ne
        ...
        <p>
          <a href="https://crea-tech.fr">Crea-tech</a> est propriétaire des
        ...
        <p>
          <a href="https://crea-tech.fr">Crea-tech</a> agit en tant qu’éditeur
          du site. <a href="https://crea-tech.fr">Crea-tech</a>
          est responsable de la qualité et de la véracité du Contenu qu’il
          publie.{" "}
        </p>
        <p>
          <a href="https://crea-tech.fr">Crea-tech</a> ne pourra être tenu
          responsable des dommages directs et indirects causés au matériel de
          l’utilisateur, lors de l’accès au site internet{" "}
          <a href="https://crea-tech.fr">Crea-tech</a>, et résultant soit de
        ...
        <p>
          <a href="https://crea-tech.fr">Crea-tech</a> ne pourra également être
          ...
          <a href="https://crea-tech.fr">Crea-tech</a>. Des espaces interactifs
          (possibilité de poser des questions dans l’espace contact) sont à la
          disposition des utilisateurs.
          <a href="https://crea-tech.fr">Crea-tech</a> se réserve le droit de
          ...
          Le cas échéant, <a href="https://crea-tech.fr">Crea-tech</a> se
        ...
        <p>
          ...
          le responsable du traitement des Données Personnelles est : Créa-tech
          sous CoopConnexion. <a href="https://crea-tech.fr">Crea-tech</a>
          est représenté par Cathy Thuliez, son représentant légal.
        </p>
        <p>
          En tant que responsable du traitement des données qu’il collecte,{" "}
          <a href="https://crea-tech.fr">Crea-tech</a> s’engage à respecter le
          cadre des dispositions légales en vigueur. Il lui appartient notamment
          au Client d’établir les finalités de ses traitements de données, de
          ...
          <a href="https://crea-tech.fr">Crea-tech</a> prend toutes les mesures
        ...
        <p>
          <a href="https://crea-tech.fr">Crea-tech</a> est susceptible de
        ...
        <ul>
          ...
          <li>
            ...
            <a href="https://crea-tech.fr">Crea-tech</a> : adresse email.{" "}
          </li>
          <li>
        ...
        <p>
          <a href="https://crea-tech.fr">Crea-tech</a> ne commercialise pas vos
          données personnelles qui sont donc uniquement utilisées par nécessité
          ou à des fins statistiques et d’analyses.
        </p>
        <h3>7.3 Droit d’accès, de rectification et d’opposition</h3>
        <p>
          Conformément à la réglementation européenne en vigueur, les
          Utilisateurs de <a href="https://crea-tech.fr">Crea-tech</a>
        ...
        <ul>
          ...
          <li>
            ...
            <a href="https://crea-tech.fr">Crea-tech</a> devra communiquer (ou
            non) ses données à un tiers qu’ils aura préalablement désigné
          </li>
        </ul>
        <p>
          Dès que <a href="https://crea-tech.fr">Crea-tech</a> a connaissance du
          décès d’un Utilisateur et à défaut d’instructions de sa part,{" "}
          <a href="https://crea-tech.fr">Crea-tech</a> s’engage à détruire ses
        ...
        <p>
          ...
          <a href="https://crea-tech.fr">Crea-tech</a> utilise ses Données
          Personnelles, demander à les rectifier ou s’oppose à leur traitement,
          l’Utilisateur peut contacter{" "}
          <a href="https://crea-tech.fr">Crea-tech</a>
          par écrit à l’adresse suivante :{" "}
        </p>
        Créa-tech sous CoopConnexion – DPO, Cathy Thuliez <br />
        18 rue Victor Picard 62300 Lens.
        <p>
          Dans ce cas, l’Utilisateur doit indiquer les Données Personnelles
          qu’il souhaiterait que <a href="https://crea-tech.fr">Crea-tech</a>
        ...
        <p>
          <a href="https://crea-tech.fr">Crea-tech</a> s’interdit de traiter,
          ...
          <a href="https://crea-tech.fr">Crea-tech</a> reste libre du choix de
        ...
        <p>
          <a href="https://crea-tech.fr">Crea-tech</a> s’engage à prendre toutes
          les précautions nécessaires afin de préserver la sécurité des
          ...
          <a href="https://crea-tech.fr">Crea-tech</a>, celle-ci devra dans les
        ...
        <p>
          ...
          des filiales de <a href="https://crea-tech.fr">Crea-tech</a> et des
        ...
        <p>
          ...
          <a href="https://crea-tech.fr">Crea-tech</a> sont principalement les
        ...
        <p>
          ...
          <a href="https://crea-tech.fr">Crea-tech</a>n'est publiée à l'insu de
          ...
          l'utilisateur du site<a href="https://crea-tech.fr">Crea-tech</a>.
        </p>
        <h3>Sécurité</h3>
        <p>
          Pour assurer la sécurité et la confidentialité des Données
          Personnelles et des Données Personnelles de Santé,{" "}
          <a href="https://crea-tech.fr">Crea-tech</a> utilise des réseaux
        ...
        <p>
          Le site<a href="https://crea-tech.fr">Crea-tech</a>contient un certain
          nombre de liens hypertextes vers d’autres sites, mis en place avec
          l’autorisation de <a href="https://crea-tech.fr">Crea-tech</a>.
          Cependant, <a href="https://crea-tech.fr">Crea-tech</a>
        ...
        <p>
          ...
          <a href="https://crea-tech.fr">https://crea-tech.fr</a> d’améliorer le
        ...
        <p>
          ...
          <a href="https://crea-tech.fr">Crea-tech</a> informe l’Utilisateur
          que, dans ce cas, il se peut que les fonctionnalités de son logiciel
        ...
        <p>
          ...
          être le cas lorsque{" "}
          <a href="https://crea-tech.fr">https://crea-tech.fr</a> ou l’un de ses
        ...
        <p>
          Le cas échéant, <a href="https://crea-tech.fr">Crea-tech</a> décline
          ...
          <a href="https://crea-tech.fr">Crea-tech</a>, résultant (i) du refus
          de Cookies par l’Utilisateur (ii) de l’impossibilité pour{" "}
          <a href="https://crea-tech.fr">https://crea-tech.fr</a> d’enregistrer
        ...
        <p>
          ...
          <a href="https://crea-tech.fr">Crea-tech</a> ou dans son application
          ...
          de
          <a href="https://crea-tech.fr">Crea-tech</a>, Twitter, Facebook,
        ...
        <p>
          ...
          <a href="https://crea-tech.fr">Crea-tech</a>. À tout moment,
          l’Utilisateur peut néanmoins revenir sur son consentement à ce que{" "}
          <a href="https://crea-tech.fr">Crea-tech</a> dépose ce type de
          cookies.
        </p>
        <h3>Article 9.2. BALISES (“TAGS”) INTERNET</h3>
        <p>
          <a href="https://crea-tech.fr">Crea-tech</a> peut employer
        ...
        <p>
          ...
          <a href="https://crea-tech.fr">Crea-tech</a> d’évaluer les réponses
        ...
        <p>
          ...
          l’attention de <a href="https://crea-tech.fr">Crea-tech</a>, et
        ...
        <p>
          ...
          <a href="https://crea-tech.fr">Crea-tech</a>est soumis au droit
          français. En dehors des cas où la loi ne le permet pas, il est fait
          attribution exclusive de juridiction aux tribunaux compétents de Lens.
        </p>
      </div>
      <Footer />
    </section>
